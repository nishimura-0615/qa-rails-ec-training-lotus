...
User.create!([{ email: "user001@test.com", password:"password1234", first_name:"user", last_name:"001",
             ...
             { email: "user002@test.com", password:"password1234", first_name:"user", last_name:"002",
